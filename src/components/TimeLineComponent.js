...
export default function TimlineComponent({ time = "Q4.2022 to Q1.2023", content = [] }) {
    ...
    return (
        <div className="timeline-home__component">
            <div className="timeline-home__component__pc">
                ...
                >
                    <div className="timeline-home__component__time">
                        <div className="timeline-home__component__time__text">{time}</div>
                    ...
                    {/* <div className="timeline-home__component__content">
                        {content.map((e, index) => (
                            <div key={index}>{e}</div>
                        ))}
                    </div> */}
            ...
            <div className="timeline-home__component__mobile">
                <div className="timeline-home__component__mobile__time " >
                    <div className="timeline-home__component__mobile__time__text">{time}</div>
                    <div className="timeline-home__component__mobile__time__dropdown">
                        <Image className="timeline-home__component__mobile__time__dropdown__img" src={"/home/dropdown.png"} width={17} height={13} alt="dropdown" />
                    </div>
                </div>

                <ul className="timeline-home__component__mobile__content">
                    {content.map((e, index) => (
                        <li key={index}>{e}</li>
                    ))}
                </ul>
